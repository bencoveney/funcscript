 ...
 */
export declare type BiValueMonadLike<Value, NotValue, MonadType extends BiValueMonad<Value, NotValue> = BiValueMonad<Value, NotValue>> = MonadLike<Value, MonadType> | NotValue;
/**
...
export interface BiValueMonad<Value, NotValue> extends Monad<Value> {
     ...
     */
    lift<Output>(mapper: (value: Value) => BiValueMonadLike<Output, NotValue>): Monad<Output>;
    /**
     ...
     * @returns.
     */
    ifElse<Output>(just: (value: Value) => BiValueMonadLike<Output, NotValue>, nothing: () => BiValueMonadLike<Output, NotValue>): Monad<Output>;
}
